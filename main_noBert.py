...
from models.model import TextCNN, TextCNN_confusion, TextCNN_confusion_noFan, TextCNN_confusion_Contrastive, \
    ...
    TextCNN_confusion_Embedding_unstudent, TextCNN_confusion_Embedding2, TextCNN_confusion_Embedding3
...
def train(args, paths=None):
    ...
    for counter in range(args.model_num):
        ...
        if args.confusion:
            model = TextCNN_confusion_Embedding3(args.filter_num, args.filter_size_dna, args.filter_size_protein,
...
if __name__ == '__main__':
    ...
    parse.model_name = "textCNN_MHSA_2layer_dropout0.5_60_34581632"
    path = []
    parse.do_train = True
    ...
    if parse.do_predict:
        PATH = os.getcwd()
        # parse.model_name = "textCNN_MHSA_2layer_dropout0.7_100__confusion"
