...
def train(args, paths=None):
    ...
    for counter in range(args.model_num):
        ...
        if args.Contrastive:
            ...
            Train.train_step_signle(train_dataset, test_dataset, args.model_name, epochs=args.epochs, model_num=counter,
                             early_stop=args.early_stop, threshold=args.threshold)
...
def do_predict(args):
    ...
    if args.confusion:
        ...
        test_label = "/data3/linming/DNA_Lin/esm/scripts/data/" + "test_labels.npy"
...
if __name__ == '__main__':
    ...
    # [3, 4, 5, 8, 16, 32]
    parse.model_name = "textCNN_dropout0.7_70_"
    path = []
    parse.do_train = True
