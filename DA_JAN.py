...
from models.model import TextCNN, TextCNN_confusion, TextCNN_CLS, TextCNN_confusion_Contrastive, ContrastiveLoss, \
    TextCNN_confusion_DA, MultipleKernelMaximumMeanDiscrepancy, Theta, JointMultipleKernelMaximumMeanDiscrepancy
...
def train(args, paths=None):
    ...
    for counter in range(args.model_num):
        ...
        Train.train_step_DA(train_source_iter, train_target_dataset, test_target_dataset, jmmd_loss, args.model_name, epochs=args.epochs, model_num=counter,
...
if __name__ == '__main__':
    ...
    parse.model_name = "DA_JAN_textCNN_dropout0.4_60_lr0.0002_256"
    path = []
    parse.do_train = True
