...
input_dir = "../../dataCenter"
output_dir = "../../dataCenter"
# data_file_list = ["source_train", "test", "source_Data", "target_data", "target_test"]
data_file_list = ["source_train", "test"]
...
for data_file in data_file_list:
    input_file = os.path.join(os.getcwd(), input_dir, data_file + ".fasta")
    ...
    # 定义保存文件的路径
    representations_file = os.path.join(os.getcwd(), output_dir, data_file + ".npy")
    labels_file = os.path.join(os.getcwd(), output_dir, data_file + "_labels.npy")
    ...
    df_data.to_csv(os.path.join(os.getcwd(), output_dir, data_file + "_list.csv"))
    # # 如果你想保存标签名
