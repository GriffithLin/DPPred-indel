...
def data_load_confusion(data_path, dna_data_direction, batch=32):
    train_protein_data_path = os.path.join("/data3/linming/DNA_Lin/dataCenter/", "train_protein.csv")
    ...
    test_protein_data_path = os.path.join("/data3/linming/DNA_Lin/dataCenter/", "test_protein.csv")
...
def data_load_confusion_KD(data_path, dna_data_direction, batch=32):
    train_protein_data_path = os.path.join("/data3/linming/DNA_Lin/dataCenter/", "source_train_index.csv")
    ...
    train_label = os.path.join("/data3/linming/DNA_Lin/dataCenter/", "source_train_labels.npy")
    train_protein_data = os.path.join("/data3/linming/DNA_Lin/dataCenter/", "source_train.npy")
...
def data_load_npy_confusion_cont_cap(data_path, dna_data_direction, batch=32, is_cont=False):
    ...
    train_cap_fea = os.path.join("/data3/linming/DNA_Lin/dataCenter/", "cap_fea_train_norm.csv")
    ...
    test_protein_data = os.path.join(data_path, "test.npy")
    test_dna_data = os.path.join(dna_data_direction, "test_dna.npy")
    test_cap_fea = os.path.join("/data3/linming/DNA_Lin/dataCenter/", "cap_fea_test_norm.csv")
...
def data_load_npy_source(data_path, dna_data_direction, batch=32, is_cont = False):
    train_label = os.path.join("/data3/linming/DNA_Lin/dataCenter/", "source_Data_labels.npy")
    train_protein_data = os.path.join("/data3/linming/DNA_Lin/dataCenter/", "source_Data.npy")
...
def data_load_source(data_path, dna_data_direction, batch=32, is_cont = False):
    ...
    train_protein_data_path = os.path.join("/data3/linming/DNA_Lin/dataCenter/", "source_Data_index.csv")
...
def data_load_npy_target(data_path, dna_data_direction, batch=32):
    train_label = os.path.join("/data3/linming/DNA_Lin/dataCenter/", "target_labels.npy")
    train_protein_data = os.path.join("/data3/linming/DNA_Lin/dataCenter/", "target.npy")
    ...
    test_label = os.path.join("/data3/linming/DNA_Lin/dataCenter/", "DA_target_test_labels.npy")
    test_protein_data = os.path.join("/data3/linming/DNA_Lin/dataCenter/", "DA_target_test.npy")
...
def data_load_target(data_path, dna_data_direction, batch=32):
    ...
    train_protein_data_path = os.path.join("/data3/linming/DNA_Lin/dataCenter/", "target_index.csv")
    ...
    test_protein_data_path = os.path.join("/data3/linming/DNA_Lin/dataCenter/", "target_test_index.csv")
...
def data_load_npy_confusion_cont_k_fold(data_path, dna_data_direction, k_fold, batch=32 , is_cont=False):
    cv = StratifiedKFold(n_splits=5, shuffle=True, random_state=42)
...
def data_load_npy_confusion_predict(data_path, dna_data_direction, batch=32):
    ...
    # test_label = os.path.join("/data3/linming/DNA_Lin/dataCenter/", "target_test_labels.npy")
    # test_protein_data = os.path.join("/data3/linming/DNA_Lin/dataCenter/", "target_test.npy")
    # test_dna_data = os.path.join(dna_data_direction, "DA",  "target_test_dna.npy")
...
def data_load_confusion_predict_DDD(data_path, dna_data_direction, batch=32):
    test_protein_data_path = os.path.join("/data3/linming/DNA_Lin/dataCenter/", "DDD_protein.csv")
