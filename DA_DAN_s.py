...
from models.model import TextCNN, TextCNN_confusion, TextCNN_CLS, TextCNN_confusion_Contrastive, ContrastiveLoss, \
    ...
    JointMultipleKernelMaximumMeanDiscrepancy, TextCNN_confusion_Embedding_unstudent
...
def train(args, paths=None):
    ...
    for counter in range(args.model_num):
        ...
        Train.train_step_DA_student(train_source_iter, train_target_dataset, test_target_dataset, mkmmd_loss, args.model_name, epochs=args.epochs, model_num=counter,
...
if __name__ == '__main__':
    ...
    # parse.model_name = "DA_DAN_non_linear_textCNN_dropout0.6_60_lr0.0002_f64_student_trade_off0.5_BS" +str(parse.batch_size)
    parse.model_name = "testing_student"
    path = []
    parse.do_train = True
    ...
    each_model = os.path.join("/data3/linming/DNA_Lin", 'saved_models', 'student.pth')
    ...
    if parse.do_predict:
        PATH = os.getcwd()
        parse.model_name = "DA_DAN_textCNN_dropout0.6_100_lr0.001_64_student_confusion"
